...
~/.tribal/channel_directory.json.  The send_message tool reads this file for
...
DIRECTORY_PATH = get_tribal_home() / "channel_directory.json"
...
def _build_from_sessions(platform_name: str) -> List[Dict[str, str]]:
    ...
    sessions_path = get_tribal_home() / "sessions" / "sessions.json"
