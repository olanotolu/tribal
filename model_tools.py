...
#   - cli.py, tribal_cli/*      -> inline on startup (no event loop)
...
def get_tool_definitions(
    ...
    if quiet_mode:
        try:
            from tribal_cli.config import get_config_path
        ...
        cache_key = (
            ...
            cfg_fp,
            bool(os.environ.get("TRIBAL_KANBAN_TASK")),
        )
...
def _compute_tool_definitions(
    ...
    if enabled_toolsets is not None:
        ...
        if os.environ.get("TRIBAL_KANBAN_TASK") and "kanban" not in effective_enabled_toolsets:
            # Dispatcher-spawned workers are scoped by TRIBAL_KANBAN_TASK and
    ...
    # This ensures that even if a composite toolset (like tribal-cli)
...
def handle_function_call(
    ...
    try:
        ...
        if not skip_pre_tool_call_hook:
            ...
            try:
                from tribal_cli.plugins import get_pre_tool_call_block_message
