...
class TestPluginContextEngineSlot:
    ...
    def test_register_engine(self):
        from tribal_cli.plugins import PluginManager, PluginContext, PluginManifest
        mgr = PluginManager()
    ...
    def test_get_plugin_context_engine(self):
        from tribal_cli.plugins import PluginManager, PluginContext, PluginManifest, get_plugin_context_engine, _plugin_manager
