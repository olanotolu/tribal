...
class TestMem0UserIdScoping:
    ...
    def test_no_user_id_no_config_uses_tribal_user(self):
        """Without user_id or config override, should default to 'tribal-user'."""
        from plugins.memory.mem0 import Mem0MemoryProvider
...
class TestAIAgentUserIdPropagation:
    ...
    def test_user_id_stored_on_agent(self):
        ...
        with patch.dict(os.environ, {"TRIBAL_HOME": "/tmp/test_tribal"}):
