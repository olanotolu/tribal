...
The unit tests in tests/tribal_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned tribal-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/tribal")
from tribal_cli.service_manager import S6ServiceManager
