...
async def test_start_gateway_verbosity_imports_redacting_formatter(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("tribal_logging.setup_logging", lambda tribal_home, mode: tmp_path)
    monkeypatch.setattr("tribal_logging._add_rotating_handler", lambda *args, **kwargs: None)
