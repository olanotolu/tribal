...
Browser automation is optional. The installer should not leave Tribal
...
def test_install_script_skips_playwright_download_when_system_browser_exists() -> None:
    ...
    assert "Skipping Playwright browser download; Tribal will use the system browser." in text
