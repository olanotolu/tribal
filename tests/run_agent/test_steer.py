...
class TestSteerCommandRegistry:
    def test_steer_in_command_registry(self):
        ...
        """
        from tribal_cli.commands import resolve_command, ACTIVE_SESSION_BYPASS_COMMANDS
    ...
    def test_steer_in_bypass_set(self):
        ...
        """
        from tribal_cli.commands import ACTIVE_SESSION_BYPASS_COMMANDS, should_bypass_active_session
