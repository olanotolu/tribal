...
def test_new_command_rotates_tribal_session_id_env_and_context(tmp_path):
    ...
    assert cli.session_id != old_session_id
    assert os.environ["TRIBAL_SESSION_ID"] == cli.session_id
    assert get_session_env("TRIBAL_SESSION_ID") == cli.session_id
