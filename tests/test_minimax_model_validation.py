...
from tribal_cli.models import validate_requested_model
...
class TestMiniMaxModelValidation:
    ...
    def _isolate_minimax(self):
        ...
        with patch("tribal_cli.models.fetch_api_models", return_value=None), \
             patch("tribal_cli.models.probe_api_models", return_value=probe_payload):
            yield
