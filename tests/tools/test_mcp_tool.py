...
class TestLoadMCPConfig:
    def test_no_config_returns_empty(self):
        ...
        with patch("tribal_cli.config.load_config", return_value={"model": "test"}):
    ...
    def test_valid_config_parsed(self):
        ...
        with patch("tribal_cli.config.load_config", return_value={"mcp_servers": servers}):
            from tools.mcp_tool import _load_mcp_config
            result = _load_mcp_config()
    ...
    def test_mcp_servers_not_dict_returns_empty(self):
        ...
        with patch("tribal_cli.config.load_config", return_value={"mcp_servers": "invalid"}):
            from tools.mcp_tool import _load_mcp_config
            result = _load_mcp_config()
            assert result == {}
...
class TestSchemaConversion:
    def test_converts_mcp_tool_to_tribal_schema(self):
...
class TestToolsetInjection:
    ...
    def test_server_toolset_skips_builtin_collision(self):
        ...
        fake_toolsets = {
            "tribal-cli": {"tools": ["terminal"], "description": "CLI", "includes": []},
    ...
    def test_server_connection_failure_skipped(self):
        ...
        fake_toolsets = {
            "tribal-cli": {"tools": [], "description": "CLI", "includes": []},
        }
