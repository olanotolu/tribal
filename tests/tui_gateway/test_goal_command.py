...
def tribal_home(tmp_path, monkeypatch):
    ...
    # Bust the goal-module DB cache so it re-resolves TRIBAL_HOME.
...
def test_slash_exec_rejects_goal_routes_to_command_dispatch(server, session):
    ...
    to command.dispatch. Without this, the TribalCLI slash-worker subprocess
