"""Tests for tribal_state.py — SessionDB SQLite CRUD, FTS5 search, export."""
...
class TestSchemaInit:
    ...
    def test_schema_version(self, db):
        from tribal_state import SCHEMA_VERSION
    ...
    def test_topic_mode_schema_is_not_auto_migrated_on_open(self, tmp_path):
        ...
        The gateway must remain rollback-safe: simply upgrading Tribal and starting
    ...
    def test_schema_sql_is_source_of_truth(self, db):
        ...
        """
        from tribal_state import SCHEMA_SQL
...
class TestConcurrentWriteSafety:
    ...
    def test_sqlite_timeout_is_at_least_30s(self, db):
        ...
        import sqlite3
        import inspect
        from tribal_state import SessionDB as _SessionDB
