 ...
 *
 * Symptom: in `tribal --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@tribal/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using tribal --tui and as i type multiline my caret at the end will often ' +
