...
import type { ScrollBoxHandle } from '@tribal/ink'
import { evictInkCaches } from '@tribal/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.TRIBAL_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
