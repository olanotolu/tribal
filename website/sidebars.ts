...
const sidebars: SidebarsConfig = {
  docs: [
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-tribal-agent',
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/software-development/software-development-tribal-agent-skill-authoring',
                    'user-guide/skills/bundled/software-development/software-development-tribal-s6-container-supervision',
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        'guides/run-tribal-with-nous-portal',
        'guides/tips',
        'guides/local-llm-on-mac',
        'guides/daily-briefing-bot',
        'guides/team-telegram-assistant',
        'guides/python-library',
        'guides/use-mcp-with-tribal',
        'guides/use-soul-with-tribal',
        'guides/use-voice-mode-with-tribal',
        'guides/build-a-tribal-plugin',
