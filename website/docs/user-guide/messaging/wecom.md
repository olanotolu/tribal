...
description: "Connect Tribal Agent to WeCom via the AI Bot WebSocket gateway"
---

# WeCom (Enterprise WeChat)

Connect Tribal to [WeCom](https://work.weixin.qq.com/) (企业微信), Tencent's enterprise messaging platform. The adapter uses WeCom's AI Bot WebSocket gateway for real-time bidirectional communication — no public endpoint or webhook needed.
...
Select **WeCom** and scan the QR code with your WeCom mobile app. Tribal will automatically create a bot application with the correct permissions and save the credentials.
...
5. Run `tribal gateway setup`, select **WeCom**, and enter the credentials when prompted
