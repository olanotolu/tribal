...
Set your Tenor API key in your environment (add to `~/.tribal/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/Tribal/tribal/blob/main/skills/media/gif-search/url)`
