...
| | |
|---|---|
| Source | Optional — install with `tribal skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Tribal Agent |
| License | MIT |
...
The script reads `~/.tribal/.env` for two optional defaults:
...
Helper script: `~/.tribal/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.tribal/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.tribal/.env`.
...
```bash
python3 ~/.tribal/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.tribal/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
