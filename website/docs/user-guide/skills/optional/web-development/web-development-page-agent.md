...
- User wants **Tribal itself to drive a browser** → use Tribal' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
