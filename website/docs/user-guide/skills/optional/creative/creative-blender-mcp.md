---
title: "Blender Mcp — Control Blender directly from Tribal via socket connection to the blender-mcp addon"
sidebar_label: "Blender Mcp"
description: "Control Blender directly from Tribal via socket connection to the blender-mcp addon"
---
...
Control Blender directly from Tribal via socket connection to the blender-mcp addon. Create 3D objects, materials, animations, and run arbitrary Blender Python (bpy) code. Use when user wants to create or modify anything in Blender.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `tribal skills install official/creative/blender-mcp` |
...
Control a running Blender instance from Tribal via socket on TCP port 9876.
