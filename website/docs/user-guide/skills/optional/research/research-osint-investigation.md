...
| | |
|---|---|
| Source | Optional — install with `tribal skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Tribal Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $TRIBAL_OSINT_CACHE/icij/ (default: ~/.cache/tribal-osint/icij/).
...
# Set TRIBAL_OSINT_UA=your-app/1.0 (your@email) to identify yourself
