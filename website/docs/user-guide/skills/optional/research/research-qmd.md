...
| | |
|---|---|
| Source | Optional — install with `tribal skills install official/research/qmd` |
...
Tribal Agent via the native MCP client. This is the preferred
...
Then configure Tribal Agent to connect via HTTP:
