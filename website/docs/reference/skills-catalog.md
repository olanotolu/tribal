...
| [`tribal-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-tribal-agent) | Configure, extend, or contribute to Tribal Agent. | `autonomous-ai-agents/tribal-agent` |
| [`kanban-codex-lane`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-kanban-codex-lane) | Use when a Tribal Kanban worker wants to run Codex CLI as an isolated implementation lane while Tribal keeps ownership of task lifecycle, reconciliation, testing, and handoff. | `autonomous-ai-agents/kanban-codex-lane` |
...
| [`kanban-worker`](/docs/user-guide/skills/bundled/devops/devops-kanban-worker) | Pitfalls, examples, and edge cases for Tribal Kanban workers. The lifecycle itself is auto-injected into every worker's system prompt as KANBAN_GUIDANCE (from agent/prompt_builder.py); this skill is what you load when you want deeper det... | `devops/kanban-worker` |
...
| [`teams-meeting-pipeline`](/docs/user-guide/skills/bundled/productivity/productivity-teams-meeting-pipeline) | Operate the Teams meeting summary pipeline via Tribal CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions. | `productivity/teams-meeting-pipeline` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`debugging-tribal-tui-commands`](/docs/user-guide/skills/bundled/software-development/software-development-debugging-tribal-tui-commands) | Debug Tribal TUI slash commands: Python, gateway, Ink UI. | `software-development/debugging-tribal-tui-commands` |
| [`tribal-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-tribal-agent-skill-authoring) | Author in-repo SKILL.md: frontmatter, validator, structure. | `software-development/tribal-agent-skill-authoring` |
| [`tribal-s6-container-supervision`](/docs/user-guide/skills/bundled/software-development/software-development-tribal-s6-container-supervision) | Modify, debug, or extend the s6-overlay supervision tree inside the Tribal Agent Docker image — adding new services, debugging profile gateways, understanding the Architecture B main-program pattern. | `software-development/tribal-s6-container-supervision` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Plan mode: write markdown plan to .tribal/plans/, no exec. | `software-development/plan` |
