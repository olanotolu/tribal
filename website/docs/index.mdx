...
slug: /
sidebar_position: 0
title: "Tribal Agent Documentation"
description: "The self-improving AI agent built by Tribal. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/Tribal/tribal" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
After installing, run `tribal setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::

## What is Tribal Agent?
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Tribal safely |
| 🧭 **[Use MCP with Tribal](/guides/use-mcp-with-tribal)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Tribal](/guides/use-voice-mode-with-tribal)** | Hands-on setup and usage patterns for Tribal voice workflows |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)** | Define Tribal' default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/guides/tips)** | Quick wins to get the most out of Tribal |
...
- **Built by model trainers** — Created by [Nous Research](https://nousresearch.com), the lab behind Tribal, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://nousresearch.com) — the lab behind Tribal, Nomos, and Psyche models
