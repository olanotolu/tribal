...
sidebar_position: 3
title: 'Learning Path'
description: 'Choose your learning path through the Tribal Agent documentation based on your experience level and goals.'
---

# Learning Path

Tribal Agent can do a lot — CLI assistant, Telegram/Discord bot, task automation, RL training, and more. This page helps you figure out where to start and what to read based on your experience level and what you're trying to accomplish.

:::tip Start Here
If you haven't installed Tribal Agent yet, begin with the [Installation guide](/getting-started/installation) and then run through the [Quickstart](/getting-started/quickstart). Everything below assumes you have a working installation.
:::

:::tip First-time provider setup
First-time users almost always want `tribal setup --portal` — one OAuth covers a model plus the four Tool Gateway tools (search/image/TTS/browser). See [Nous Portal](/integrations/nous-portal).
:::
...
- **Just browsing?** Check the [Key Features](#key-features-at-a-glance) table for a quick overview of everything Tribal Agent can do.
...
Use Tribal Agent as an interactive terminal assistant for writing, reviewing, and running code.
...
:::tip
Pass files directly into your conversation with context files. Tribal Agent can read, edit, and run code in your projects.
:::

### "I want a Telegram/Discord bot"

Deploy Tribal Agent as a bot on your favorite messaging platform.
...
7. [Use Voice Mode with Tribal](/guides/use-voice-mode-with-tribal)
...
:::tip
Cron jobs let Tribal Agent run tasks on a schedule — daily summaries, periodic checks, automated reports — without you being present.
:::

### "I want to build custom tools/skills"

Extend Tribal Agent with your own tools and reusable skill packages.

1. [Plugins](/user-guide/features/plugins)
2. [Build a Tribal Plugin](/guides/build-a-tribal-plugin)
...
page is for built-in Tribal core development, not the usual user/custom-tool path.
:::

### "I want to train models"

Use reinforcement learning to fine-tune model behavior with Tribal Agent's RL training pipeline (powered by [Atropos](https://github.com/NousResearch/atropos)).
...
:::tip
RL training works best when you already understand the basics of how Tribal Agent handles conversations and tool calls. Run through the Beginner path first if you're new.
:::

### "I want to use it as a Python library"

Integrate Tribal Agent into your own Python applications programmatically.
...
| **Code Execution** | Run Python scripts that call Tribal tools programmatically | [Code Execution](/user-guide/features/code-execution) |
