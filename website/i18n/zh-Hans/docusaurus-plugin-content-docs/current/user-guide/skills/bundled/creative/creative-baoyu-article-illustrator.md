...
改编自 [baoyu-article-illustrator](https://github.com/JimLiu/baoyu-skills)，适配 Tribal Agent 的工具生态系统。
...
或使用预设：`edu-visual` → 一次性指定 type + style + palette。参见 [style-presets.md](https://github.com/Tribal/tribal/blob/main/skills/creative/baoyu-article-illustrator/references/style-presets.md)。
...
参见 [references/styles.md](https://github.com/Tribal/tribal/blob/main/skills/creative/baoyu-article-illustrator/references/styles.md)，包含核心风格、完整图库及类型 × 风格兼容性说明。
...
完整流程：[references/workflow.md](https://github.com/Tribal/tribal/blob/main/skills/creative/baoyu-article-illustrator/references/workflow.md#step-1-detect-reference-images)。
...
完整流程：[references/workflow.md](https://github.com/Tribal/tribal/blob/main/skills/creative/baoyu-article-illustrator/references/workflow.md#step-2-analyze)。
...
完整流程：[references/workflow.md](https://github.com/Tribal/tribal/blob/main/skills/creative/baoyu-article-illustrator/references/workflow.md#step-3-confirm-settings)。
...
完整模板：[references/workflow.md](https://github.com/Tribal/tribal/blob/main/skills/creative/baoyu-article-illustrator/references/workflow.md#step-4-generate-outline)。
...
1. 按照 [references/prompt-construction.md](https://github.com/Tribal/tribal/blob/main/skills/creative/baoyu-article-illustrator/references/prompt-construction.md) 创建 prompt 文件。
...
在对应段落后插入 `![描述](https://github.com/Tribal/tribal/blob/main/skills/creative/baoyu-article-illustrator/{relative-path}/NN-{type}-{slug}.png)`。Alt 文本：用文章语言简洁描述。
...
| 文件 | 内容 |
|------|---------|
| [references/workflow.md](https://github.com/Tribal/tribal/blob/main/skills/creative/baoyu-article-illustrator/references/workflow.md) | 详细流程 |
| [references/usage.md](https://github.com/Tribal/tribal/blob/main/skills/creative/baoyu-article-illustrator/references/usage.md) | 调用示例 |
| [references/styles.md](https://github.com/Tribal/tribal/blob/main/skills/creative/baoyu-article-illustrator/references/styles.md) | 风格图库 + 调色板图库 |
| [references/style-presets.md](https://github.com/Tribal/tribal/blob/main/skills/creative/baoyu-article-illustrator/references/style-presets.md) | 预设快捷方式（type + style + palette） |
| [references/prompt-construction.md](https://github.com/Tribal/tribal/blob/main/skills/creative/baoyu-article-illustrator/references/prompt-construction.md) | Prompt 模板 |
