...
| File operations | Bash commands | Tribal file tools (write_file, read_file) |
...
Reference files can be overwritten directly (they're unchanged from upstream). SKILL.md must be manually merged since it contains Tribal-specific adaptations.
