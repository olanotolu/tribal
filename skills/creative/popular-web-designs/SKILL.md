...
version: 1.0.0
author: Tribal Agent + Teknium (design systems sourced from VoltAgent/awesome-design-md)
license: MIT
...
Each template includes a **Tribal Implementation Notes** block at the top with:
...
<head>
  ...
  <!-- Paste the Google Fonts <link> from the template's Tribal notes -->
