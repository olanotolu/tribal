...
description: Use when a Tribal Kanban worker wants to run Codex CLI as an isolated implementation lane while Tribal keeps ownership of task lifecycle, reconciliation, testing, and handoff.
version: 1.0.0
author: Tribal Agent
license: MIT
metadata:
  tribal:
    ...
    related_skills: [kanban-worker, codex, tribal-agent]
---
