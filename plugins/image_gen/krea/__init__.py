...
# Tribal uses 3 abstract aspect ratios. Map to Krea's enum (which is wider).
    ...
    def generate(
        ...
        **kwargs: Any,
        ...
        if not api_key:
            return error_response(
                error=(
                    "KREA_API_KEY not set. Run `tribal tools` → Image "
        ...
        headers = {
            ...
            "User-Agent": "Tribal-Agent/1.0 (krea-image-gen)",
        }
