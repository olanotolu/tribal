...
Config via environment variables (profile-scoped via each profile's .env):
  ...
  OPENVIKING_AGENT   — Tenant agent (default: tribal)
...
class _VikingClient:
    ...
    def __init__(self, endpoint: str, api_key: str = "",
        ...
        self._agent = agent or os.environ.get("OPENVIKING_AGENT", "tribal")
...
class OpenVikingMemoryProvider(MemoryProvider):
    ...
    def get_config_schema(self):
        return [
            ...
            {
                "key": "agent",
                "description": "OpenViking agent ID within the account ([tribal], useful in multi-agent mode)",
                "default": "tribal",
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._agent = os.environ.get("OPENVIKING_AGENT", "tribal")
    ...
    def _tool_read(self, args: dict) -> str:
        ...
        # (e.g. viking://user/tribal/.overview.md).
