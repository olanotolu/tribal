...
required — uses aiohttp which is already a Tribal dependency.
...
def interactive_setup() -> None:
    ...
    ``tribal_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Tribal delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # tribal_cli/setup.py::_setup_mattermost function.
