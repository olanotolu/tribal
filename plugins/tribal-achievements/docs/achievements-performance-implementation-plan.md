# Tribal Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.tribal/plugins/tribal-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.tribal/plugins/tribal-achievements/scan_checkpoint.json`.
