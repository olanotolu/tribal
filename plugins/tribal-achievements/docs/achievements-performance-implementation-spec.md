# Tribal Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.tribal/plugins/tribal-achievements/state.json` (existing unlock state)
  - `~/.tribal/plugins/tribal-achievements/scan_snapshot.json` (new)
  - `~/.tribal/plugins/tribal-achievements/scan_checkpoint.json` (new)
