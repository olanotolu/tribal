...
DEFAULT_UA = (
    "tribal-osint-investigation/0.2 "
    "(+https://github.com/Tribal/tribal; "
    "set TRIBAL_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("TRIBAL_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
