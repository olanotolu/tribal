...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateTribal: "Tribal aktualisieren",
    updatingTribal: "Tribal wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "Tribal-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `tribal plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.tribal/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.tribal/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.tribal/skills/ geladen",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare Tribal-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "Tribal-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze Tribal mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald Tribal ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "Tribal scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
