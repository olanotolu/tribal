...
const STORAGE_KEY = "tribal-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `tribal_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "tribal-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-tribal-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-tribal-theme-font", "true");
