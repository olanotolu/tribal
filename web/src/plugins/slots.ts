 ...
 * `window.__TRIBAL_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Tribal brand in the top bar
 ...
 *  `window.__TRIBAL_PLUGINS__.registerSlot(...)`.
 *
