...
from tribal_cli.proxy.adapters.base import UpstreamAdapter
from tribal_cli.proxy.adapters.nous_portal import NousPortalAdapter
from tribal_cli.proxy.adapters.xai import XAIGrokAdapter

# Registry of available adapter classes keyed by provider name as used on
# the ``tribal proxy start --provider <name>`` CLI flag.
