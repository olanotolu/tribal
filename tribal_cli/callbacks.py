...
into prompt_toolkit's event loop. Each function takes the TribalCLI instance
...
from tribal_cli.banner import cprint, _DIM, _RST
...
def prompt_for_secret(cli, var_name: str, prompt: str, metadata=None) -> dict:
    ...
    The secret is stored in ~/.tribal/.env and never exposed to the model.
    """
