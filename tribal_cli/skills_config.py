"""
Skills configuration for Tribal Agent.
`tribal skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.tribal/config.yaml under:
...
from tribal_cli.config import cfg_get, load_config, save_config
from tribal_cli.colors import Colors, color
from tribal_cli.platforms import PLATFORMS as _PLATFORMS
