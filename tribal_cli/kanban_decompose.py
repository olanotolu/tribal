...
Invoked by ``tribal kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Tribal Agent board.
...
def _profile_author() -> str:
    """Mirror of ``tribal_cli.kanban._profile_author``."""
    return (
