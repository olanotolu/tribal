...
from tribal_cli.config import get_env_value, load_config
from tribal_cli.nous_account import NousPortalAccountInfo, get_nous_portal_account_info
...
def get_nous_subscription_features(
    ...
    *,
    ...
    # Tool Gateway via `tribal model`, so direct credentials should NOT
...
def prompt_enable_tool_gateway(
    ...
    *,
    ...
    try:
        from tribal_cli.setup import prompt_choice
    except Exception:
        return set()
