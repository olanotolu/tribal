"""
Cron subcommand for tribal CLI.
...
def cron_list(show_all: bool = False):
    ...
    if not jobs:
        ...
        print(color("Create one with 'tribal cron create ...' or the /cron command in chat.", Colors.DIM))
        return
    ...
    if not find_gateway_pids():
        ...
        print(color("     Start it with: tribal gateway install", Colors.DIM))
        print(color("                    sudo tribal gateway install --system  # Linux servers", Colors.DIM))
        print()
...
def cron_status():
    ...
    if pids:
        ...
        print("    tribal gateway install    # Install as a user service")
        print("    sudo tribal gateway install --system  # Linux servers: boot-time system service")
        print("    tribal gateway            # Or run in foreground")
...
def cron_command(args):
    ...
    print("Usage: tribal cron [list|create|edit|pause|resume|run|remove|status|tick]")
    sys.exit(1)
