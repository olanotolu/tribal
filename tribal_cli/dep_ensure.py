...
def _has_tribal_agent_browser() -> bool:
    ...
    # install.sh installs globally into $TRIBAL_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-TribalHome", str(get_tribal_home()),
        ]
    else:
