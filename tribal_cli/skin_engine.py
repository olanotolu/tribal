"""Tribal CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.tribal/skins/ or as built-in presets.
...
.. code-block:: python
    ...
    set_active_skin("mytheme")            # Switch to user skin from ~/.tribal/skins/
...
Drop a YAML file in ``~/.tribal/skins/<name>.yaml`` following the schema above.
