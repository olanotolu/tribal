...
Usage:
    tribal pairing list              # Show all pending + approved users
    tribal pairing approve <platform> <code>  # Approve a pairing code
    tribal pairing revoke <platform> <user_id> # Revoke user access
    tribal pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle tribal pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: tribal pairing {list|approve|revoke|clear-pending}")
        print("Run 'tribal pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.tribal/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'tribal pairing list' to see pending codes.\n")
