...
the get_anchored_view / get_messages_around primitives in tribal_state.
...
# Third-party integrations tag their sessions with TRIBAL_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from tribal_state import DEFAULT_DB_PATH
