# Streaming LLM Response Support for Tribal Agent
...
```
TRIBAL_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("TRIBAL_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `tribal_cli/config.py` | 1 | +streaming config defaults |
