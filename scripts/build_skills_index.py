#!/usr/bin/env python3
"""Build the Tribal Skills Index — a centralized JSON catalog of all skills.
...
`tribal skills search/install` can use it without hitting the GitHub API.
...
# Ensure TRIBAL_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Tribal Skills Index...", flush=True)
