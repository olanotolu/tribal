#!/usr/bin/env python3
"""Build the Tribal Model Catalog — a centralized JSON manifest of curated models.
...
Tribal CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Tribal release.
...
# Ensure TRIBAL_HOME is set for imports that touch it at module level.
os.environ.setdefault("TRIBAL_HOME", os.path.join(os.path.expanduser("~"), ".tribal"))

from tribal_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "tribal-agent repo",
            "docs": "https://tribal.dev/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
